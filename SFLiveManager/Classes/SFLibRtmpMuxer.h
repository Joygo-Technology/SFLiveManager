...
typedef enum {
    BitRateSmooth    = 350 * 1024,
    BitRateStandard  = 500 * 1024,
    BitRateHigh      = 800 * 1024,
    BitRateHD        = 1100 * 124
} BitRateQuality;
...
- (void)setVolumeForAccomp:(int)volume;

- (void)setVolumeForVoice:(int)volume;

- (int)getVolumnOfAccomp;

- (int)getVolumnOfVoice;
@end
