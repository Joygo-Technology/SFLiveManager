...
/* 设置日志输出方式 : url如下例子
	...
	"console://"
*/
int32_t osl_log_set_target(const char *url );

/* 取得日志输出方式 */
void osl_log_get_target( char *buf, int32_t size );

/* 输出调试信息 */
int32_t osl_log_debug(const char *format, ... );

/* 输出警告信息 */
int32_t osl_log_warn(const char *format, ... );

/* 输出错误信息 */
int32_t osl_log_error(const char *format, ... );
