...
/* 推荐线程堆栈大小(bytes) */
#define THREAD_DEFAULT_STACK_SIZE	65535
/* 推荐线程优先级 */
...
/* 创建线程，成功后处于暂停状态，priority=0(最高), priority=255(最低) */
    void* osl_thread_create( const char *name, uchar_t priority, int32_t stack_size,
...
void osl_threadInitName(char *name,int32_t size);
