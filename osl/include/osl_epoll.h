...
#define OSL_EPOLL_CTL_ADD      EV_ADD
#define OSL_EPOLL_CTL_DEL      EV_DELETE
#define OSL_EPOLL_CTL_MOD      EV_ADD
    
#define OSL_EPOLL_IN       EVFILT_READ
#define OSL_EPOLL_OUT      EVFILT_WRITE
#define OSL_EPOLL_PRI      0x00
#define OSL_EPOLL_ERR      0x00
#define OSL_EPOLL_HUP      0x00
#define OSL_EPOLL_ET       0x00
...
/* 生成一个epoll专用的文件描述符，num是指定生成描述符的最大范围 */
